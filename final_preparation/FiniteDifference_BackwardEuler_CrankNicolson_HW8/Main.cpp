...
int main() {
	...
	cout << "\nCrank-Nicolson with LU and �� = 0.45: " << endl;
	for (int i = 1; i < 5; i++) {
		int M = pow(4, i);
	...
	cout << "\nBackward Euler with LU and �� = 5: " << endl;
	for (int i = 1; i < 5; i++) {
		int M = pow(4, i);
	...
	cout << "\nCrank-Nicolson with LU and �� = 5: " << endl;
	for (int i = 1; i < 5; i++) {
		int M = pow(4, i);
